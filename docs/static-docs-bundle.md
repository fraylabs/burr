...
asset_name: burr-docs-v0.23.0.zip
asset_url: https://github.com/fraylabs/burr/releases/download/burr-v0.23.0/burr-docs-v0.23.0.zip
```
...
```txt
burr-docs-v0.23.0/manifest.json
```
