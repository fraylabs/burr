...
```bash
cargo install burr --version 0.20.0
```
...
The generated starter installs `burr-build123d==0.9.0` from PyPI.
...
and `.gitignore`. The generated project depends on `burr-build123d==0.9.0`
from PyPI.
