...
STEP_FILE = "practical-driver-access-blocked.step"

depth = 12.0
width = 34.0
height = 22.0
driver_access_diameter = 4.8
driver_side_clearance = 0.6

design = BurrDesignData(
    artifact_id="gallery-practical-driver-access-blocked",
