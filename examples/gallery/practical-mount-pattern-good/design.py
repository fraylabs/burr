...
STEP_FILE = "practical-mount-pattern-good.step"

depth = 10.0
width = 42.0
height = 30.0
hole_centers = [(-12.0, -8.0), (12.0, -8.0), (-12.0, 8.0), (12.0, 8.0)]

design = BurrDesignData(
    artifact_id="gallery-practical-mount-pattern-good",
...
design.measurement("mount_pattern_max_pitch_error_mm", 0.0)
design.part(
    "plate",
